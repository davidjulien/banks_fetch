...
INSERT INTO mapping(id, pattern, fix_date, period, budget_id, categories_id, store_id) VALUES (1, 'PETITEBOUTIQUE', null, null, 1, ARRAY[1,52], 2);
INSERT INTO mapping(id, pattern, fix_date, period, budget_id, categories_id, store_id) VALUES (2, 'URSSAF', 'previous', null, 1, ARRAY[1,42], 3);
INSERT INTO mapping(id, pattern, fix_date, period, budget_id, categories_id, store_id) VALUES (3, 'CHARGES', 'next_if_end', 'quarter', 1, ARRAY[1,42], 4);
