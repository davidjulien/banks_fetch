...
INSERT INTO mappings(id, pattern, fix_date, period, budget_id, categories_id, store_id) VALUES (1, 'PETITEBOUTIQUE', 'none', 'month', 1, ARRAY[1,52], 2);
INSERT INTO mappings(id, pattern, fix_date, period, budget_id, categories_id, store_id) VALUES (2, 'URSSAF', 'previous', 'month', 1, ARRAY[1,42], 3);
INSERT INTO mappings(id, pattern, fix_date, period, budget_id, categories_id, store_id) VALUES (3, 'CHARGES', 'next_if_end', 'quarter', 1, ARRAY[1,42], 4);
